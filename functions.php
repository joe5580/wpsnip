...
function custom_meta_box_markup($object)
{
    ...
    ?>
        <div>
            ...
            <p class="meta-options">
            <label for="meta-box-dropdown">Colour</label>
            <select name="meta-box-dropdown">
                <?php 
                    $option_values = array('Red', 'Black', 'Green');
            ...
            <label for="meta-box-size">Size</label>
            <select name="meta-box-size">
                <?php 
                    $option_values = array('XL', 'XXL', 'L');

                    foreach($option_values as $key => $value) 
                    {
                        if($value == get_post_meta($object->ID, "meta-box-size", true))
                        {
                            ?>
                                <option selected><?php echo $value; ?></option>
                            <?php    
...
function save_custom_meta_box($post_id, $post, $update)
{
    ...
    if(isset($_POST["meta-box-size"]))
    {
        $meta_box_size_value = $_POST["meta-box-size"];
    }   
    update_post_meta($post_id, "meta-box-size", $meta_box_size_value);
